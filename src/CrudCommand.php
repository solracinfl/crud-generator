...
class CrudCommand extends Command
{
    ...
    public function fire()
    {
        ...
        if($this->argument('child_of_facility'))
            $child_of_facility = $this->argument('child_of_facility');
        ...
        if ($this->option('fields')) {
            ...
            $this->call('crud:controller', ['name' => $name . 'Controller', '--child_of_facility'=>$child_of_facility, '--crud-name' => $name]);
            ...
            //$this->call('crud:migration', ['name' => strtolower($name), '--schema' => $fields]);

            $this->call('crud:view', ['name' => $name, '--fields' => $fields, 'title'=> $title, 'key'=>$key, 'table_name'=> $table_name]);
        } else {
    ...
    protected function getArguments()
    {
        return [
            ...
            ['child_of_facility', InputArgument::REQUIRED, 'is the object a child of a facility.'],
        ];
    }
